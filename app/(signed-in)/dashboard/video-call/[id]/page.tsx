...
const VideoCall = () => {
  ...
  // based on different stages of the call, we can render out different things
  ...
  if (callingState === CallingState.RECONNECTING) {
    return (
      <StatusCard
        title="Reconnecting..."
        description="Connection lost, attempting to re-establish connection to the call."
        className="rounded-lg bg-yellow-50 border border-yellow-200"
      >
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 z-10">
        <CallControls onLeave={handLeave} />
      </div>
